...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Couleurs principales ChopExpress
        primary: {
          50: '#ECFDF5',
          100: '#D1FAE5',
          200: '#A7F3D0',
      ...
      boxShadow: {
        ...
        'primary': '0 4px 14px 0 rgb(16 185 129 / 0.2)',
        'secondary': '0 4px 14px 0 rgb(245 158 11 / 0.2)',
        'accent': '0 4px 14px 0 rgb(239 68 68 / 0.2)',
      },
      animation: {
  ...
  // Configuration pour le mode sombre (futur)
  darkMode: 'class',
  // Préfixe pour éviter les conflits
  prefix: '',
  // Important pour surcharger les styles
  important: false,
  // Séparateur pour les variantes
  separator: ':',
  ...
  // Configuration du purge pour la production
  purge: {
